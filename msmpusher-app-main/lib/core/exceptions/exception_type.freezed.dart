...
/// @nodoc
class _$ExceptionTypeTearOff {
  const _$ExceptionTypeTearOff();

  ServerException<T> serverException<T>(
      {int? responseNo,
      bool response = true,
  ...
  CacheException<T> cacheException<T>(
      {int? responseNo,
      bool response = true,
      required ExceptionCode code,
      required T message}) {
  ...
  PlatformsException<T> platformsException<T>(
      {int? responseNo,
      bool response = true,
      required ExceptionCode code,
      required T message}) {
    return PlatformsException<T>(
      responseNo: responseNo,
      response: response,
      code: code,
      message: message,
...
/// @nodoc
const $ExceptionType = _$ExceptionTypeTearOff();
...
abstract class ServerException<T> implements ExceptionType<T> {
  const factory ServerException(
      ...
      bool response,
      required ExceptionCode code,
      required T message}) = _$ServerException<T>;
...
abstract class CacheException<T> implements ExceptionType<T> {
  const factory CacheException(
      ...
      bool response,
      required ExceptionCode code,
      required T message}) = _$CacheException<T>;
...
abstract class PlatformsException<T> implements ExceptionType<T> {
  const factory PlatformsException(
      ...
      bool response,
      required ExceptionCode code,
      required T message}) = _$PlatformsException<T>;
